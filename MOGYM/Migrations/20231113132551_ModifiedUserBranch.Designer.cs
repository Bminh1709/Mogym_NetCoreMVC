...
namespace MOGYM.Migrations
{
    ...
    [Migration("20231113132551_ModifiedUserBranch")]
    partial class ModifiedUserBranch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MOGYM.Models.Admin", b =>
                {
                    b.HasOne("MOGYM.Models.User", null)
                        .WithOne()
                        .HasForeignKey("MOGYM.Models.Admin", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MOGYM.Models.Trainee", b =>
                {
                    b.HasOne("MOGYM.Models.User", null)
                        .WithOne()
                        .HasForeignKey("MOGYM.Models.Trainee", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MOGYM.Models.Trainer", b =>
                {
                    ...
                    b.HasOne("MOGYM.Models.User", null)
                        .WithOne()
                        .HasForeignKey("MOGYM.Models.Trainer", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
